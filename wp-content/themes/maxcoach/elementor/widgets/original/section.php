...
class Modify_Widget_Section extends Modify_Base {
	...
	public function section_layout( $element ) {
		...
		$section_gap['options'] = [
			...
			'default'  => esc_html__( 'Normal', 'maxcoach' ),
			'no'       => esc_html__( 'No Gap', 'maxcoach' ),
			'narrow'   => esc_html__( 'Narrow', 'maxcoach' ),
			'extended' => esc_html__( 'Extended', 'maxcoach' ),
			'wide'     => esc_html__( 'Wide', 'maxcoach' ),
			'wider'    => esc_html__( 'Wider', 'maxcoach' ),
